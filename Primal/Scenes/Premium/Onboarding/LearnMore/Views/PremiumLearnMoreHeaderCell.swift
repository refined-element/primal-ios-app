...
class PremiumLearnMoreHeaderCell: UITableViewCell {
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        let free = PremiumTableHeaderCenteredTitleView(title: "Individual").constrainToSize(width: 69)
        let premium = PremiumTableHeaderCenteredTitleView(title: "Business").constrainToSize(width: 82)
